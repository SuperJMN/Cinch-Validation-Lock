namespace ComplexValidation.Tests
{
    ...
    public class ConfigWindowViewModelTests
    {
        ...
        {
            var sut = new ConfigWindowViewModel(new LomoConfigServiceMock(SampleData.WithNameAndNoSelectedCustomer), null, null, null, null);
        ...
        {
            var sut = new ConfigWindowViewModel(new LomoConfigServiceMock(SampleData.UniqueConfigThatIsValid), null, null, null, null);
        ...
        {
            var sut = new ConfigWindowViewModel(new LomoConfigServiceMock(SampleData.UnsavedUniqueConfigThatIsValid), null, null, null, null);
        ...
        {
            var sut = new ConfigWindowViewModel(new LomoConfigServiceMock(), null, null, null, null);
